...
public class ClientMainFrame extends JFrame implements ActionListener, Runnable {
	...
	public ClientMainFrame()
	{
		...
		mf.b6.addActionListener(this); // 메뉴에서 채팅으로 가기
		mf.b1.addActionListener(this); // 메뉴에서 홈으로 가기
	}
	...
	public void actionPerformed(ActionEvent e) {
		...
		else if(e.getSource()==login.b1)
		{
			...
			{
				JOptionPane.showMessageDialog(this, "아이디를 확인 해주세요.");
				login.tf.setText("");
				login.pf.setText("");
				login.tf.requestFocus();
			}
			...
			{
				JOptionPane.showMessageDialog(this, "비밀번호를 확인 해주세요.");
				login.pf.setText("");
				login.pf.requestFocus();
			}
			else
