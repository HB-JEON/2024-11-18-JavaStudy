...
// abstract 메소드가 있는 경우 상속 시에 무조건 구현 후에 사용
// 문법
...
public class 추상클래스 {
	...
	public static void main(String[] args) {
		// TODO Auto-generated method stub
		// 관련된 클래스(상속받은)를 모아서 한개 객체명으로 제어
//		도형 a=new 네모();
		//    --------- 상속 받아서 메소드를 구현한 클래스
		/*
		 *   오버라이딩 - 기능을 변경하여 사용
...
//		a.colorSelect();
		...
		System.out.print("도형 선택:네모(1), 삼각형(2), 원형(3)");
...
//		a.colorSelect();
//		a.draw();
		도형[] a= {null, new 네모(), new 삼각형(), new 원형()};
				a[mode].colorSelect();
				a[mode].draw();
