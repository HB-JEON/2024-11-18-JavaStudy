 ...
 *         오라클 연결 : ~DAO
 *         브라우저 연결 : ~Model(~Controller, ~Action)
 *        브라우저 ========= 오라클
 *         | HTML/CSS > 화면 UI
 *        브라우저 ========= 자바 ======= 오라클
 *          React > 클래스
