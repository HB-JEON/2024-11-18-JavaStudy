...
//			j++;
//		}
//		System.out.println("모음 갯수:"+(a+e+i+o+u));
...
//		}
//		System.out.println();
//		// 문자열을 입력을 받은 후 반대로 출력
//		// 이미지를 반대로 출력하는 프로그램 작성 byte
//		System.out.print("문자열 입력:");
//		String str=scan.nextLine();
//		i=str.length()-1;
//		while(i>=0)
